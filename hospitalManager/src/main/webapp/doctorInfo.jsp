    ...
    <div class="body-content">
        <form method="post" class="form-x" action="${pageContext.request.contextPath}/doctor/updateDoctor" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input" name="job_number" value="${doctors.job_number}" readonly/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group" >
                ...
                <div class="field">
                    <input type="text" class="input" name="registration_fee" value="${doctors.registration_fee}" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
